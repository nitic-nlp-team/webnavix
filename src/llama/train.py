...
def main(cfg):
    ...
    demos = [
        wl.Demonstration(demo_name, base_dir=cfg.data.base_dir)
    ...
    model_kwargs: dict[str, typing.Any] = dict(torch_dtype=torch.bfloat16)
    ...
    with Path.open(model_save_dir.joinpath(input_records_fname), "w") as f:
